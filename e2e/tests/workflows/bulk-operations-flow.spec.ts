...
test.describe('@workflow Bulk Operations Workflow', () => {
  ...
  test.skip('複数素材の一括ダウンロード - ダウンロード機能未実装のためスキップ', async ({ page }) => {
  ...
  test.skip('複数素材の一括削除 - 一括削除機能未実装のためスキップ', async ({ page }) => {
    // TODO: 一括削除機能実装後に有効化
    // このテストは以下をテストする予定:
    // 1. 複数素材を選択
    // 2. 一括削除ボタンをクリック
  ...
  test.skip('複数素材への一括タグ付け - 一括編集機能未実装のためスキップ', async ({ page }) => {
    // TODO: 一括編集機能実装後に有効化
    // このテストは以下をテストする予定:
    // 1. 複数素材を選択
    // 2. 一括編集ボタンをクリック
